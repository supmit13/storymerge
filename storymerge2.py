...
#DEVELOPER_KEY = 'xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx'
DEVELOPER_KEY = 'xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx'
...
"""
def computetimespanfromcontent(content, longsentences=False):
    ...
    for segment in segmentslist:
        ...
        for vid in videoslist:
            ...
            if not os.path.exists(outpath):
                ...
                addtextonmp4stream(videopath, segmentcontent, videowithtextpath, longsentences)
